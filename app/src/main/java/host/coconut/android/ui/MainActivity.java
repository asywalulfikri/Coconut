package host.coconut.android.ui;
...
*/
       ...
       /* showApiProgressDialog(App.getAppComponent(), new ResourceDao(this) {
            ...
            public void call() {
                this.postPhoneNumber2(
                        new PhoneRequestModel("081212341212"), MainActivity.this, Objects.requireNonNull(BaseDao.getInstance(this, IConfig.KEY_CALLER_API_SOURCE)).callback);
            }
        }, "Loading", false);*/
